<div class="wrapper container-fluid">
    {!! Form::open(['url' => route('pagesEdit',array('page'=>$data['id'])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!} <!--'enctype'=>'multipart/form-data' нужен, чтобы отправлять файлы вместе с
    формой-->
