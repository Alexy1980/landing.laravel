<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        </div><!--метод old() предоставляет доступ к данным, сохраненным в сессии из предыдущего запроса-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::textarea('text', old('text'), ['id'=>'editor','class' => 'form-control','placeholder'=>'Введите текст страницы']) !!} <!--id = 'editor' нужен для редактора ckeditor-->
        </div>
    </div>
    ...
    <script>
        CKEDITOR.replace('editor'); // добавляем ckeditor
    </script>
