@if(isset($pages) && is_object($pages))
    @foreach($pages as $k => $page)
        @if($k%2 == 0) <!--для четных отображаем секцию home, для нечетных aboutUs-->
            ...
            <div class="inner_wrapper">
                <div class="container">
                    ...
                    <div class="inner_section">
                        <div class="row">
                            <!--используем хелпер Html, третьим параметром передаем название класса, это необходимо
                            для работы макета-->
    ...
    <div class="container">
        ...
        <div class="col-lg-4 {{($k%3 > 0) ? 'borderLeft' : ''}} {{($k > 2) ? 'mrgTop' : ''}}">
            <div class="service_block">
                <div class="service_icon delay-03s animated wow  zoomIn"> <span><i class="fa
                {{$service->icon}}"></i></span>
                </div>
        ...
        <section id="Portfolio" class="content">
            ...
            @if(isset($tags) && is_object($tags))
                <div id="filters" class="sixteen columns">
                    <ul class="clearfix">
                        <!--id=all отображает все фильтры, поэтому ее выносим вне foreach-->
    ...
    <section class="page_section team" id="team"><!--main-section team-start-->
        <div class="container">
            ...
            @foreach($peoples as $k => $people)
                <div class="team_area">
                    <!--$k*3 + 2 определяет задержку по времени с которым появляется картинка-->
